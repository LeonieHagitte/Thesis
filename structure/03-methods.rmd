...
## Item Creation  
We employed a combination of literature review and the "person-related empirical method" to derive items as indicators for the latent factors of data literacy. The process involved drafting a set of items, which were then reviewed through cognitive interviews in an iterative manner for refinement. These cognitive interviews were conducted with members of the general public, treating laypeople as experts. Subsequently, item difficulty and discriminatory power were assessed in a pilot study involving 25 participants from the general public.
