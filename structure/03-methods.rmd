...
[@brandgruwel2009]. In this study this construct is used as a proxy for information literacy.
...
requires valid responses to at least 12 of the 16 items. I expect the final questionnaire to correlate moderately up to highly positive with the SWE-IV-16 [@behm2018], measuring peoples ability to engage in information behaviour.
...
resulting mean values range between 1 and 7. I expect a small to moderate positive correlation with the NFC-K [@beißert2015], assessing the Need for Cognition (NFC).
...
mean score of the items within each subscale [@schauffel2021]. I expect a moderate, positive correlation of the final scale with the five general items of the ICT-SC25 [@schauffel2021].
...
@rammstedt2007 for reference values). I expect small to moderate positive correlations with openness and conscientiousness of the BFI-10 [@rammstedt2014]. 
