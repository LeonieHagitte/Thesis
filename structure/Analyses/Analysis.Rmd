...
## taus?
theothrsh_tau <- sd(taus[grep('t1', rownames(taus))]) + 
...
obj <- function(chisq, df, pvalue, rmsea.robust, srmr, cfi.robust, crel, tau) {
  ...
  out4 = 1 / (1 + exp(-10 * (tau - 0.1))) # Maximizing the standard deviation of tau
...
Time Required: 1637.815 seconds
...
lavaan::inspect(kfold_sel2$final, 'est')$tau
```
