...
By synthesizing heterogeneous definitions and perspectives (as e.g. highlighted in the literature review from @Cui2023) into cohesive, unified representations and selectively incorporating relevant features while establishing cross-disciplinary connections. With questions in mind like "What factors and facets do most definitions share?", "What are specifics to certain definitions, addressed to special professions?", we arrived at the following structure of the concept:  
...
One decision that needs to be done by the researcher before the item selection with 'stuart', is the design of the measurement model, or how many items per factor the final scal should have.
