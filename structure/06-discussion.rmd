...
The final model showed acceptable fit (XXX), according to the combinational rule for RMSEA and SRMR of @hu1999. But not according to the rules that are most commonly used not to the combinational rule, that resulted in the least sum of type 1 and type 2 error rates [@hu1999]. 
