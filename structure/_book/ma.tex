...
{\centering \includegraphics[width=\textwidth]{images/Models_MA} 
...
My definition incorporates statistical literacy (\citeproc{ref-Gal2002}{Gal, 2002}) by emphasizing data interpretation, analysis, and understanding different types of data representations, such as graphs and tables (Statistics).
...
Tag & Item & Mean & SD\\
\hline
F1F6 & Bei der Auswertung von Grafiken bin ich in der Lage, Widersprüche zu erkennen. & 3.74 & .83\\
F1F8 & Ich erkenne, ob die Interpretationen Anderer zu den vorliegenden Daten passen. & 3.66 & .97\\
F1F11 & Ich kenne unterschiedliche Arten von Grafiken. & 4.48 & .75 \\
F1F14 & Ich kann die zentrale These eines wissenschaftlichen Textes erkennen. & 3.92 & .88\\
F2F2 & Wenn Ich die Glaubwürdigkeit von Informationen beurteile, berücksichtige ich den Ruf der Quelle. & 4.04 & 1.04\\
F2F6 & Ich kenne Merkmale zur Bewertung von Datenqualität. & 3.19 & 1.13\\
F2F15 & Ich überprüfe die Qualifikation von Autor*innen, bevor ich mich auf die Informationen verlasse. & 3.18 & .94\\
F2F20 & Ich erkenne, wenn Daten schlechte Qualität haben. & 3.25 & .97\\
F3F2 & Ich beschäftige mich mit Informationen, die meine Ansichten in Frage stellen. & 3.57 & .80\\
F3F4 & Ich kann schnell und ohne Schwierigkeiten Informationen in Datenbanken finden. & 3.38 & .92\\
F3F6 & Ich bevorzuge datengestützte Informationen, wenn ich mir eine Meinung bilde. & 3.75 & 1.09\\
F3F9 & Ich kann neue Informationen in meinen Wissensstand integrieren. & 4.32 & .64\\
F4F1 & Ich kann Ergebnisse in Streudiagrammen darstellen. & 2.88 & 1.45\\
F4F3 & Ich kann Daten in Grafiken so präsentieren, dass sie für verschiedene Zielgruppen verständlich sind. & 3.45 & 1.23\\
F4F6 & Ich kann aus verschiedenen Darstellungsformen, die am besten geeignete auswählen. & 3.54 & 1.01\\
F4F8 & Ich kann mit Programmen Grafiken erstellen, um Ergebnisse zu präsentieren. & 3.73 & 1.17\\
F5F3 & Ich bin in der Lage, einfache Datenbanken zu verwalten. & 3.44 & 1.31\\
F5F4 & Ich kann Datensätze mit einfachen statistischen Methoden analysieren. & 3.28 & 1.26\\
F5F8 & Wenn ich mit umfangreichen Datensätzen konfrontiert werde, kann ich daraus Erkenntnisse gewinnen. & 3.47 & 1.08\\
F5F18 & Wenn ich Daten analysiere, achte ich auf ein systematisches Vorgehen. & 3.74 & 1.13\\

\hline
\end{tabular}
}
\vspace{10pt}
\small\textit{Note}. The items sorted by latent factor, selected by the algorithm. The tag refers to the name, the item had in the programming.
\end{table}
...
Education5 (A-levels) also shows a statistically significant positive effect on F4F3(``Ich kann Daten in Grafiken so präsentieren, dass sie für verschiedene Zielgruppen verständlich sind.''), with a coefficient of 3.91 and a p-value of 0.04. This indicates that individuals with A-levels as their highest educational level score, on average, 3.91 points higher than the reference group, which again consisted of individuals with higher educational levels for this item.
...
\bibitem[\citeproctext]{ref-dorsch_wissen}
