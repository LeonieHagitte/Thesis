...
Although the RMSEA was a bit low, the initial model exhibited an acceptable to good fit, with indices suggesting acceptable model fit (CFI = .96, SRMR = .07, RMSEA = .03), according to Hu \& Bentler (\citeproc{ref-hu1999}{1999}).
