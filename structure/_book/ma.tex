...
\emph{``Does the proposed set of items effectively capture the latent factor structure of self-rated data literacy, and can the created scale be considered a reliable and valid measure of this construct?''}

\emph{Hypothesis 1: The test-data will support the suggested latent factor structure and the proposed measurement model.}\\
\emph{Hypothesis 2: I expect that the latent factor structure found in the initial analysis will be supported by a different sample.}\\
