...
\emph{Conscientiousness} is one factor of the \emph{Big Five} (\citeproc{ref-costa1992}{Costa \& McCrae, 1992}) and refers to an individuals propensity for self-discipline, dutifulness, and striving for achievement in alignment with external standards or expectations. It encompasses levels of impulse control, regulation, and goal-directed behavior Toegel \& Barsoux (\citeproc{ref-toegel2012}{2012}). High conscientiousness is characterized by persistence and focus, often perceived as stubbornness, whereas low conscientiousness is linked to flexibility and spontaneity, potentially manifesting as carelessness and unreliability (\citeproc{ref-toegel2012}{Toegel \& Barsoux, 2012}). Individuals with high conscientiousness tend to prefer planned actions over spontaneous ones (\citeproc{ref-costa1992}{Costa \& McCrae, 1992}; \citeproc{ref-john2008}{John et al., 2008}).\\
...
To assess self-perceived competence in using information and communication technology (ICT), the five general items of the ICT-SC25 (\citeproc{ref-schauffel2021}{Schauffel et al., 2021}) were used.
...
Algorithm based item selection was done via the R package `stuart'(\citeproc{ref-schultze2022}{Schultze, 2022}) and the confirmatory factor analysis (CFA) via the R package `lavaan'(\citeproc{ref-rosseel2012}{Rosseel, 2012}). Inference criteria: Model fit was assessed using established criteria (\citeproc{ref-hu1999}{Hu \& Bentler, 1999}). Comprising of Chi square significance testing as well as a combination of several fit indices, i.e., RMSEA \textless{} 0.05, SRMR \textless{} 0.07, CFI \textgreater{} 0.95. Model-specific cutoff values were considered as well, using the `ezCutoffs' package (\citeproc{ref-schmalbach2019}{Schmalbach et al., 2019}).
...
This allows for meaningful comparisons of latent means between groups rather than being due to measurement bias or differences in how the construct is understood or measured across groups (\citeproc{ref-cheung2002}{Cheung \& Rensvold, 2002}; \citeproc{ref-riordan1994}{Riordan \& Vandenberg, 1994}).
The lack of residual invariance suggests that the residuals (unexplained variance in the indicators) are not equivalent across groups. This implies that there are group-specific differences in how much of the variance in the observed variables remains unexplained by the latent factors. Meaning, this lack of residual invariance complicates the interpretation of differences between groups (\citeproc{ref-cheung2002}{Cheung \& Rensvold, 2002}). While the factors themselves may be measured similarly (because scalar invariance holds), the amount of unexplained variability in the responses differs across groups, indicating potential unmodeled differences in how the groups respond to certain items.
